...
export function ArticleShareBar({ title, url }: { title: string; url: string }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 py-5 my-8" style={{ borderTop: '1px solid #2a2a2a', borderBottom: '1px solid #2a2a2a' }}>
      <span className="text-[10px] font-black uppercase tracking-widest shrink-0" style={{ color: '#6b7280' }}>Share</span>

      {/* Native share / copy link */}
      <button
        onClick={share}
        className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-black uppercase tracking-widest transition-opacity hover:opacity-70"
